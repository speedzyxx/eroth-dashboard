...
export function Killboard({ kills }: KillboardProps) {
  return (
    <section className="relative z-10 rounded-2xl border border-[#2a3344] bg-[#181e29]/p-4 sm:p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-[#8b95a8]">Monitor de bajas · Small-Scale</p>
        </div>
      ...
      <div className="space-y-3">
        ...
        {kills.length === 0 && (
          <p className="py-8 text-center text-sm text-[#8b95a8]">
            Sin kills todavía. Conecta la API o inicia la sesión.
          </p>
        )}
      </div>
    </section>
