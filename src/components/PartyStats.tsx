...
import { formatFame, formatSilver, makeItem } from "@/lib/format";
import { weaponDisplayName } from "@/lib/weaponRoles";
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-[10px] text-[#5b6578]">
                  ...
                  {p.weaponType ? ` · ${weaponDisplayName(p.weaponType)}` : ""}
                </p>
              </div>
            </div>
  ...
  return (
    <section className="relative z-10 space-y-4">
      <div className="rounded-xl border border-[#2a3344] bg-[#12171f] px-4 py-3 text-xs text-[#9ca3af]">
        ...
        <p className="mt-1">
          Aliados: <span className="text-emerald-400">{alliesCount}</span> · Enemigos:{" "}
          <span className="text-rose-400">{enemiesCount}</span> · Total: {total}
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-[#2a3344] bg-[#181e29] p-4 sm:p-5">
        <div className="mb-4 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-[#8b95a8]">MVP · Top looters · K/D</p>
          </div>
        </div>
                  ...
                  <div className="mb-1 flex items-center justify-between gap-2 text-sm">
                    <span className="flex min-w-0 items-center gap-2 text-[#e8edf5]">
                      ...
                      <span className="truncate">
                        {p.name}
                        <span className="ml-1 text-[10px] text-[#6b7280]">{p.guildName || ""}</span>
                      </span>
                    </span>
